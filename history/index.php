...
$select1 = mysqli_query($conn, "SELECT * FROM project ") or die('Подключение оборвано');
...
<link href="../local/templates/a/components/bitrix/news/history/bitrix/news.list/.default/style.css@1710891715387.css" type="text/css"  rel="stylesheet" />
...
<script>(window.BX||top.BX).message({'LANGUAGE_ID':'ru','FORMAT_DATE':'DD.MM.YYYY','FORMAT_DATETIME':'DD.MM.YYYY HH:MI:SS','COOKIE_PREFIX':'BITRIX_SM','SERVER_TZ_OFFSET':'10800','UTF_MODE':'Y','SITE_ID':'s1','SITE_DIR':'/','USER_ID':'','SERVER_TIME':'1713471935','USER_TZ_OFFSET':'0','USER_TZ_AUTO':'Y','bitrix_sessid':'1176d0099a35715dab9434e1056ce213'});</script>
            ...
            <div class="header__inner">
                ...
                <div class="header__main">
                    ...
                    <nav class="header__menu">
		                        ...
		                        <div class="header__menu-i"><a href="looking/index.php">Ищут дом</a></div>
		

	
	<div class="header__menu-i"><a href="happy/index.html">Счастливые истории</a></div>
        ...
        <main class="main">
	<div class="pet-page">
               <div class="section__banner _high">
                    <div class="inner">
                        <h1 class="h1 color6">Проекты фонда</h1>
                        <div class="h3 color6">Спасибо за помощь!</div>
                        <picture>
                            <source srcset="/local/templates/a/img/line8_mob.svg" media="(max-width: 530px)"><img src="../local/templates/a/img/line8.svg" alt="">
                        </picture>
                    </div>
                </div>
                <section class="section _pb-8 _pt-8 inner">
                    <div class="pets">
                         <?php
                            ...
                            echo '
	                        <div class="pet-card" id="'.$row1['id'].'">
                               
			<img src="'.$row1['img_proj'].'" alt="'.$row1['name_proj'].'" loading="lazy">
                            <div class="pet-card__main">
								<div class="pet-card__title h4"><a class="no-decoration" href="na-lechenie-barzelya/index.html"><b>'.$row1['name_proj'].'</b></a></div>
                                <div class="progress">
                                    <div class="progress__line"><span style="width: 36.598827181787%"></span>
                                                                        
                                                                    </div>

                                    <div class="progress__info">
                                        <div class="progress__info-i">
                                            <div class="progress__label">собрали:</div>
                                            <div class="progress__value">53 050</div>
                                        </div>
                                        <div class="progress__info-i">
                                            <div class="progress__label">цель:</div>
                                            <div class="progress__value">'.$row1['money_proj'].'</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-block">'.$row1['text_proj'].'</div>
                                <div class="pet-card__btns"><a class="btn _full" href="na-lechenie-barzelya/index.html">Помочь</a>
        ...
        <footer class="footer">
            <div class="footer__inner inner">
                <div class="footer__main">
                    <div class="footer__col"><a class="footer__logo" href="../index.php"><img src="../local/templates/a/img/logo.png" alt=""></a>
                    ...
                    <div class="footer__col">
                        ...
                        <nav class="footer__menu">
							...
							<a class="footer__menu-i" href="looking/index.php">Ищут дом</a>
